...
//    @PreAuthorize("@ss.hasPermi('system:tbl:list')")
    @GetMapping("/list")
    public ResultVO<IPage<UreportFileTbl>> list(UreportFileTblDTO ureportFileTblDTO)
    {
//

        return new ResultVO<IPage<UreportFileTbl>>(SuccessEnums.QUERY_SUCCESS,ureportFileTblService.pageReport(ureportFileTblDTO));
    }

    /**
     * 导出【请填写功能名称】列表
     */
  /*  @PreAuthorize("@ss.hasPermi('system:tbl:export')")
    @Log(title = "【请填写功能名称】", businessType = BusinessType.EXPORT)
    @GetMapping("/export")
    public AjaxResult export(UreportFileTbl ureportFileTbl)
    {
     ...
     * 获取【请填写功能名称】详细信息
     */
   /* @PreAuthorize("@ss.hasPermi('system:tbl:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增【请填写功能名称】
     */
  /*  @PreAuthorize("@ss.hasPermi('system:tbl:add')")
     ...
     * 修改【请填写功能名称】
     */
  /*  @PreAuthorize("@ss.hasPermi('system:tbl:edit')")
     ...
     * 删除【请填写功能名称】
     */
    /*@PreAuthorize("@ss.hasPermi('system:tbl:remove')")
