...
public class QRCodeUtils {
    ...
    public static BufferedImage createImage(String content, String imgPath) throws Exception {
        ...
        // 插入图片
        QRCodeUtils.insertImage(image, imgPath);
        return image;
    }
    ...
    public static void encode(String content, String destPath,String fileName,
                              boolean needCompress) throws Exception {
        QRCodeUtils.encode(content, null, destPath,fileName, needCompress);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String logoPath = "E:\\aaa\\pabg222.png";
        String destPath = "E:/aaa/";
        String filename="ddds.jpg";
        System.out.println(QRCodeUtils.encode(text, logoPath, destPath,filename, true));
    }
}