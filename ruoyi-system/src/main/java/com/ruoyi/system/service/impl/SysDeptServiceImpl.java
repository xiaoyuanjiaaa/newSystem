...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper,SysDept> implements ISysDeptService
{
    ...
    public int updateDept(SysDept dept)
    {
        ...
        if (StringUtils.isNotNull(newParentDept) && StringUtils.isNotNull(oldDept))
        {
            ...
            //修改deptlevel
            dept.setLevel(String.valueOf(Integer.parseInt(newParentDept.getLevel())+1));
    ...
    @Override
    public List<GroupCompleteNumber> groupDeptComplete(AppHealthReportCountDTO countDTO) {

        return deptMapper.groupDeptComplete(countDTO);

    }

    @Override
    public List<HReport> getYesData(AppHealthReportCountDTO countDTO) {
        List<HReport>  list =  baseMapper.getYesData(countDTO);
        return list;
    }

    @Override
    public List<SysDept> selectNoLevel() {
        return baseMapper.selectNoLevel();
    }

    @Override
    public SysDept selectDeptByLeaderId(Long leaderId) {
        return baseMapper.selectDeptByLeaderId(leaderId);
    }
